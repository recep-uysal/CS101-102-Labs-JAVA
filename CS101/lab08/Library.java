...
public class Library
{
   ...
   public String toString()
   {
      ...
      else
      {
         ...
         {
            if ( b1.onLoan() == true )
               information = information + ( b1.getTitle() + " Authour: " + b1.getAuthour()) + " The duedate: " + b1.getDueDate() + "\n";
            else
         ...
         {
            if ( b2.onLoan() == true )
               information = information + ( b2.getTitle() + " Authour: " + b2.getAuthour()) + " The duedate: " + b2.getDueDate() + "\n";
            else
         ...
         {
            if ( b3.onLoan() == true )
               information = information + ( b3.getTitle() + " Authour: " + b3.getAuthour()) + " The duedate: " + b3.getDueDate() + "\n";
            else
         ...
         {
            if ( b4.onLoan() == true )
               information = information + ( b4.getTitle() + " Authour: " + b4.getAuthour()) + " The duedate: " + b4.getDueDate() + "\n";
            else 
